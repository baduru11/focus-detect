...
interface ParticlesProps extends ComponentPropsWithoutRef<"div"> {
  ...
  quantity?: number;
  /**
   * Controls how strongly particles are influenced by mouse position.
   * Higher values = less responsive.
   * @default 50
   */
  staticity?: number;
  /**
   * Controls the easing of particle movement toward the mouse.
   * Higher values = smoother/slower.
   * @default 50
   */
  ease?: number;
  /**
  ...
  size?: number;
  /**
   * When changed, particles are reinitialized.
   * @default false
   */
  refresh?: boolean;
  /**
  ...
  color?: string;
  /**
   * Horizontal velocity bias applied to all particles.
   * @default 0
   */
  vx?: number;
  /**
   * Vertical velocity bias applied to all particles.
   * @default 0
   */
  vy?: number;
}
